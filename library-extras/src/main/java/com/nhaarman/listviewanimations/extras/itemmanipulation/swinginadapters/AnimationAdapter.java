 ...
 */
package com.nhaarman.listviewanimations.extras.itemmanipulation.swinginadapters;
...
/**
 * A {@link com.nhaarman.listviewanimations.BaseAdapterDecorator} class which applies multiple {@link com.nineoldandroids.animation.Animator}s at once to
 ...
 */
public abstract class AnimationAdapter extends BaseAdapterDecoratorExtended {
     ...
     * This call is also valid when the {@link android.view.View}s haven't been drawn yet.
     * Will also call setShouldAnimate(true).
     */
    @SuppressWarnings("UnusedDeclaration")
